...
public class BankZegondAccountsController {

    int bankPort;
    private static final String host = "127.0.0.1";

    public BankZegondAccountsController(int bankPort) {
        this.bankPort = bankPort;
    }

    public String createBankAccount(String firstName, String lastName, String userName, String password, String repeatPassword) throws IOException, IOException {
