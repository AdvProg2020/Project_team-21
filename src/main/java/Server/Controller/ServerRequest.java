...
public enum ServerRequest {
    ...
    GETALLAUCTIONS,GETALLFILES,GETALLSELLERFILES,POSTUPLOADFILE,GETACCOUNT
    GETALLAUCTIONS,GETALLFILES,GETALLSELLERFILES,POSTUPLOADFILE,POSTBUYFILE,GETCUSTOMERFILES,GETFILE
}
